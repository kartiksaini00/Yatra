    ...
    <>
      <section className='w-full py-12 md:py-24 lg:pt-32 px-6 md:px-0'>
        <div className='max-w-7xl mx-auto px-4 md:px-6'>
          <h2 className='text-3xl font-bold tracking-tighter sm:text-5xl text-center mb-3 font-serif bg-linear-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent'>Featured Destinations</h2>
          ...
          <div className="slider-container">
            <Slider {...settings}>
              {destinationJson.map((destination, index) => (
                <div key={destination.name} className="px-2 sm:px-3">
                  <article
                    className="group relative h-full flex flex-col overflow-hidden rounded-3xl 
                              ...
                              hover:-translate-y-3 hover:border-red-200/50

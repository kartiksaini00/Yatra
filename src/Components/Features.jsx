import { Hotel, Plane, Map, Camera,Headphones,Shield} from 'lucide-react'
        ...
        <div className='max-w-7xl mx-auto px-4 md:px-6'>
         ...
         <div className='grid gap-8 sm:grid-cols-2 lg:grid-cols-3'>
            {features.map((feature, index) => (
                <div key={index} className="transition-all bg-red-50 border rounded-lg hover:shadow-lg p-6">
